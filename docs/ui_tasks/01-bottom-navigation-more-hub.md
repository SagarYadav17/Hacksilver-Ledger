# Task 01: Bottom Navigation + More Hub

- [x] Add shared Material 3 bottom navigation widget.
- [x] Wire root destinations: Home, Activity, Loans, Accounts, More.
- [x] Use route replacement so root navigation does not grow stack.
